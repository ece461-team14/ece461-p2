...
async function scheduleRun() {
  try {
    ...
    console.error('Error scheduling run:', error.response ? error.response.data : error.message);
  }
}
...
async function checkProgress() {
  try {
    ...
    console.error('Error checking progress:', error.response ? error.response.data : error.message);
  }
}
...
async function getBestScore() {
  try {
    ...
    console.error('Error getting best score:', error.response ? error.response.data : error.message);
  }
}
...
async function getLastScore() {
  try {
    ...
    console.error('Error getting last score:', error.response ? error.response.data : error.message);
  }
}
...
async function downloadLog(logPath) {
  try {
    ...
    console.error('Error downloading log:', error.response ? error.response.data : error.message);
  }
}
